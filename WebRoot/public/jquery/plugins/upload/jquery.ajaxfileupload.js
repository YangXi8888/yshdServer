/*
 * // jQuery Ajax File Uploader // // @author: Jordan Feldstein <jfeldstein.com> // // -
 * Ajaxifies an individual <input type="file"> // - Files are sandboxed. Doesn't
 * matter how many, or where they are, on the page. // - Allows for extra
 * parameters to be included with the file // - onStart callback can cancel the
 * upload by returning false
 */
	...
	$.fn.ajaxfileupload = function(options) {
		...
		return this.each(function() {
			...
			var wrapElement = function(element) {
				...
				$('body')
						.after('<iframe width="0" height="0" style="display:none;" name="'
