...
public class WBsbbqkZrrVO extends CssBaseBpoVO {
...
super();
    ...
    //主凭证序号，用于与t_wb_sbbqk关联查询外籍个人离职离境清算;
 ...
 public String getZymc() {
  ...
  public void  setDhrq(Calendar dhrq) {
    status.put("DH_RQ", dhrq);
    this.dhrq=dhrq;
}
  ...
  public void  setJydwnsrmc(String jydwnsrmc) {
    status.put("JYDWNSRMC", jydwnsrmc);
    this.jydwnsrmc=jydwnsrmc;
}

  public void  setJydwswglm(String jydwswglm) {
	/** 数据库JYDWSWGLM为Long类型;
	 	类型转换 String  ->Long */
    if(null!=jydwswglm&&jydwswglm.length()>0 ) {
    	status.put("JYDWSWGLM", new Long(jydwswglm));
    }
    this.jydwswglm=jydwswglm;
}
  ...
  public void  setRzdwhy(String rzdwhy) {
    status.put("RZDWHY", rzdwhy);
    this.rzdwhy=rzdwhy;
}

  public void  setRzdwmc(String rzdwmc) {
    status.put("RZDWMC", rzdwmc);
    this.rzdwmc=rzdwmc;
}
  ...
  public void  setRzdwswglm(String rzdwswglm) {
    ...
    if(null!=rzdwswglm&&rzdwswglm.length()>0 ) {
    	status.put("RZDWSWGLM", new Long(rzdwswglm));
    }
  ...
  public void  setZhts(String zhts) {
	/** 数据库ZHTS为Long类型;
	 	类型转换 String  ->Long */
    if(null!=zhts&&zhts.length()>0 ) {
    	status.put("ZHTS", new Long(zhts));
    }
    this.zhts=zhts;
}

  public void  setZjlxdm(String zjlxdm) {
    status.put("ZJLX_DM", zjlxdm);
    this.zjlxdm=zjlxdm;
}

  public void  setZjlxmc(String zjlxmc) {
    status.put("ZJLX_MC", zjlxmc);
    this.zjlxmc=zjlxmc;
}

  public void  setZjhm(String zjhm) {
    status.put("ZJ_HM", zjhm);
    this.zjhm=zjhm;
}

  public void  setZpzxh(String zpzxh) {
    status.put("ZPZ_XH", zpzxh);
    this.zpzxh=zpzxh;
}
...
/*
	...
	yy.MM.dd 第12种
*/
  //dhrq  日期类转换 dhrq 的String 的类型 Set方法
  public void  setStr_dhrq(String str_dhrq ){
	//indexFomat 表示日期的格式类型；默认是第3种，可以修改为你需要的格式
	int indexFomat=3	;
	if (str_dhrq!="")
		this.setDhrq(DateUtils.parseFormatDate(str_dhrq,indexFomat));
	else
		this.setDhrq(null);
}

  //dhrq  日期类转换 dhrq 的String 的类型 Get方法
  public String  getStr_dhrq(){
	//indexFomat 表示日期的格式类型；默认是第3种，可以修改为你需要的格式
	int indexFomat=3	;
	if (null!=this.dhrq)
		return DateUtils.toDateStr(this.dhrq,indexFomat);;
	return "";
}
