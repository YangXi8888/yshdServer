...
public class WBjmcztdsqbBPO extends CssBaseBPO {

public WBjmcztdsqbBPO() {
super();
}

private static final String TABLENAME = "DB_WSBS.T_WB_WS_YH_JMCZTDSQB";

private static  WBjmcztdsqbVO loadConcreteBPO(ResultSet rs) throws SQLException {
 		WBjmcztdsqbVO    vo = new WBjmcztdsqbVO()	 ;
     	...
     	vo.setYwsxdm(rs.getString("YWSX_DM"));
...
private static WBjmcztdsqbVO queryByWhere(Connection con,String tablename,String sqlOrder,String sqlWhere,ArrayList sqlParams,boolean isCount) throws SQLException {

	ResultSet result=null;
	PreparedStatement ps=null;
	result = findAllByWhere(con,tablename,sqlOrder,  sqlWhere, sqlParams,isCount,result,ps);

	WBjmcztdsqbVO vo = null;
	if (result != null) {
		    if(result.next())
...
public static boolean insert(Connection con , WBjmcztdsqbVO vo)throws SQLException {
...
* @throws SQLException
*/
public static WBjmcztdsqbVO queryByPK(Connection con,String LSH) throws SQLException {
	String strSqlWhere="LSH=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(LSH);
...
* @throws SQLException
*/
 public static boolean updateByPK(Connection con,String LSH, WBjmcztdsqbVO vo) throws SQLException {
	String strSqlWhere="LSH=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(LSH);
