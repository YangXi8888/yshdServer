...
public class WBjbxxbcjlxBPO extends CssBaseBPO {

	public WBjbxxbcjlxBPO() {
		super();
	}

	private static final String TABLENAME = "DB_WSBS.T_WB_GRXX_B_CJLX";

	private static WBjbxxbcjlxVO loadConcreteBPO(ResultSet rs)
			throws SQLException {
		WBjbxxbcjlxVO vo = new WBjbxxbcjlxVO();
		vo.setCjlxdm(rs.getString("CJLX_DM"));
	...
	private static WBjbxxbcjlxVO queryByWhere(Connection con, String tablename,
	...
	public static boolean insert(Connection con, WBjbxxbcjlxVO vo)
			throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static WBjbxxbcjlxVO queryByPK(Connection con, String PZ_XH,
	...
	public static boolean updateByPK(Connection con, String PZ_XH,
			String MX_XH, WBjbxxbcjlxVO vo) throws SQLException {
		String strSqlWhere = "PZ_XH=?  AND MX_XH=? ";
		ArrayList sqlParams = new ArrayList();
		sqlParams.add(PZ_XH);
		sqlParams.add(MX_XH);
