...
public class WBjbxxbtzBPO extends CssBaseBPO {

public WBjbxxbtzBPO() {
super();
}

private static final String TABLENAME = "DB_WSBS.T_WB_GRXX_B_TZ";

private static  WBjbxxbtzVO loadConcreteBPO(ResultSet rs) throws SQLException {
 		WBjbxxbtzVO    vo = new WBjbxxbtzVO()	 ;
     	vo.setBtzdwdjzclxdm(rs.getString("BTZDW_DJZCLXDM"));
     	vo.setBtzdwdz(rs.getString("BTZDW_DZ"));
     	vo.setBtzdwhydm(rs.getString("BTZDW_HYDM"));
     	vo.setBtzdwmc(rs.getString("BTZDW_MC"));
     	vo.setBtzdwsdszsfsdm(rs.getString("BTZDW_SDSZSFSDM"));
     	vo.setBtzdwswglm(rs.getString("BTZDW_SWGLM"));
     	vo.setBtzdwyzbm(rs.getString("BTZDW_YZBM"));
     	vo.setGrtzje(String.valueOf(rs.getDouble("GRTZ_JE")));
     	vo.setGstzje(String.valueOf(rs.getDouble("GSTZ_JE")));
...
private static WBjbxxbtzVO queryByWhere(Connection con,String tablename,String sqlOrder,String sqlWhere,ArrayList sqlParams,boolean isCount) throws SQLException {
...
public static boolean insert(Connection con , WBjbxxbtzVO vo)throws SQLException {
...
* @throws SQLException
*/
public static WBjbxxbtzVO queryByPK(Connection con,String PZ_XH) throws SQLException {
	String strSqlWhere="PZ_XH=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(PZ_XH);
...
* @throws SQLException
*/
 public static boolean updateByPK(Connection con,String PZ_XH, WBjbxxbtzVO vo) throws SQLException {
	String strSqlWhere="PZ_XH=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(PZ_XH);
