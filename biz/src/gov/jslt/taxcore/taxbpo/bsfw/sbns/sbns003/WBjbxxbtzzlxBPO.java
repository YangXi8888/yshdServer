...
public class WBjbxxbtzzlxBPO extends CssBaseBPO {

	public WBjbxxbtzzlxBPO() {
		super();
	}

	private static final String TABLENAME = "DB_WSBS.T_WB_GRXX_B_TZZLX";

	private static WBjbxxbtzzlxVO loadConcreteBPO(ResultSet rs)
			throws SQLException {
		WBjbxxbtzzlxVO vo = new WBjbxxbtzzlxVO();
		vo.setMxxh(String.valueOf(rs.getLong("MX_XH")));
		vo.setPzxh(rs.getString("PZ_XH"));
		vo.setTzzlxdm(rs.getString("TZZLX_DM"));
	...
	private static WBjbxxbtzzlxVO queryByWhere(Connection con,
	...
	public static boolean insert(Connection con, WBjbxxbtzzlxVO vo)
			throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static WBjbxxbtzzlxVO queryByPK(Connection con, String PZ_XH,
	...
	public static boolean updateByPK(Connection con, String PZ_XH,
			String MX_XH, WBjbxxbtzzlxVO vo) throws SQLException {
		String strSqlWhere = "PZ_XH=?  AND MX_XH=? ";
		ArrayList sqlParams = new ArrayList();
		sqlParams.add(PZ_XH);
		sqlParams.add(MX_XH);
