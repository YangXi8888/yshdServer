...
public class WBjbxxbjnlxBPO extends CssBaseBPO {

	public WBjbxxbjnlxBPO() {
		super();
	}

	private static final String TABLENAME = "DB_WSBS.T_WB_GRXX_B_JNLX";

	private static WBjbxxbjnlxVO loadConcreteBPO(ResultSet rs)
			throws SQLException {
		WBjbxxbjnlxVO vo = new WBjbxxbjnlxVO();
		vo.setJnlxdm(rs.getString("JNLX_DM"));
	...
	private static WBjbxxbjnlxVO queryByWhere(Connection con, String tablename,
	...
	public static boolean insert(Connection con, WBjbxxbjnlxVO vo)
			throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static WBjbxxbjnlxVO queryByPK(Connection con, String PZ_XH,
	...
	public static boolean updateByPK(Connection con, String PZ_XH,
			String MX_XH, WBjbxxbjnlxVO vo) throws SQLException {
		String strSqlWhere = "PZ_XH=?  AND MX_XH=? ";
		ArrayList sqlParams = new ArrayList();
		sqlParams.add(PZ_XH);
		sqlParams.add(MX_XH);
