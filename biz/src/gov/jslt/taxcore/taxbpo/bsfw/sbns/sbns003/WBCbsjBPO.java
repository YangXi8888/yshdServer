...
import gov.jslt.taxevent.bsfw.sbns.sbns003.WBCbsjVO;

public class WBCbsjBPO extends CssBaseBPO {

public WBCbsjBPO() {
super();
}

private static final String TABLENAME = "DB_WSBS.T_WB_CBSJXX";

private static  WBCbsjVO loadConcreteBPO(ResultSet rs) throws SQLException {
 		WBCbsjVO    vo = new WBCbsjVO()	 ;
     	vo.setEsbcgbj(rs.getString("ESB_CGBJ"));
     	vo.setFwjgdm(rs.getString("FWJG_DM"));
     	vo.setGljgdm(rs.getString("GLJG_DM"));
     	vo.setJcjgdm(rs.getString("JCJG_DM"));
     	vo.setJdlydm(rs.getString("JDLY_DM"));
     	vo.setJiancjgdm(rs.getString("JIANCJG_DM"));
     	vo.setMxxh(rs.getString("MX_XH"));
     	vo.setPzxh(rs.getString("PZ_XH"));
     	vo.setSkssjgdm(rs.getString("SKSSJG_DM"));
     	vo.setSsqq(DateUtils.convSqlTimestampToUtilCalendar(rs.getTimestamp("SSQQ")));
     	vo.setSsqz(DateUtils.convSqlTimestampToUtilCalendar(rs.getTimestamp("SSQZ")));
...
private static WBCbsjVO queryByWhere(Connection con,String tablename,String sqlOrder,String sqlWhere,ArrayList sqlParams,boolean isCount) throws SQLException {
...
public static boolean insert(Connection con , WBCbsjVO vo)throws SQLException {
...
* @throws SQLException
*/
public static boolean deleteByPK(Connection con,String PZ_XH, String MX_XH) throws SQLException {
...
* @throws SQLException
*/
public static WBCbsjVO queryByPK(Connection con,String PZ_XH, String MX_XH) throws SQLException {
	String strSqlWhere="PZ_XH=?  AND MX_XH=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(PZ_XH);
 	sqlParams.add(MX_XH);
...
* @throws SQLException
*/
 public static boolean updateByPK(Connection con,String PZ_XH, String MX_XH, WBCbsjVO vo) throws SQLException {
	String strSqlWhere="PZ_XH=?  AND MX_XH=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(PZ_XH);
 	sqlParams.add(MX_XH);
