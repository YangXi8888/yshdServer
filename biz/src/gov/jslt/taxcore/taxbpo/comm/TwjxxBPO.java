...
public class TwjxxBPO extends CssBaseBPO {

	public TwjxxBPO() {
		super();
	}

	private static final String TABLENAME = "DB_WSBS.T_WJXX";

	private static TwjxxVO loadConcreteBPO(ResultSet rs) throws SQLException {
		TwjxxVO vo = new TwjxxVO();
		vo.setLsh(rs.getString("LSH"));
		vo.setLshwj(rs.getString("LSH_WJ"));
		vo.setScbj(String.valueOf(rs.getLong("SCBJ")));
		vo.setWjdx(rs.getString("WJDX"));
		vo.setWjlx(String.valueOf(rs.getLong("WJLX")));
		vo.setWjmc(rs.getString("WJMC"));
		vo.setWjwz(rs.getString("WJWZ"));
	...
	private static TwjxxVO queryByWhere(Connection con, String tablename,
	...
	public static boolean insert(Connection con, TwjxxVO vo)
			throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static boolean deleteByPK(Connection con, String LSH_WJ)
			throws SQLException {
		String strSqlWhere = "LSH_WJ=? ";
		ArrayList sqlParams = new ArrayList();
		sqlParams.add(LSH_WJ);
	 ...
	 * @throws SQLException
	 */
	public static TwjxxVO queryByPK(Connection con, String LSH_WJ)
			throws SQLException {
		String strSqlWhere = "LSH_WJ=? ";
		ArrayList sqlParams = new ArrayList();
		sqlParams.add(LSH_WJ);
	 ...
	 * @throws SQLException
	 */
	public static boolean updateByPK(Connection con, String LSH, TwjxxVO vo)
			throws SQLException {
	...
	public static List getListByPK(Connection con, String LSH_WJ)
			throws SQLException {
		ArrayList sqlParams = new ArrayList();
		sqlParams.add(LSH_WJ);
		List list = queryByZdyWhere(con, TABLENAME, null, "LSH_WJ=?",
				sqlParams, false);
		if (null == list) {
			list = new ArrayList();
		}
