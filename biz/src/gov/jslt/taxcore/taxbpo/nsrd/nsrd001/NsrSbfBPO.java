...
public class NsrSbfBPO extends CssBaseBPO {
	...
	private static NsrSbfVO queryByWhere(Connection con, String tablename,
	...
	private static ArrayList<NsrSbfVO> queryByZdyWhere(Connection con,
		...
		result = findAllByWhere(con, tablename, sqlOrder, sqlWhere, sqlParams,
				isCount, result, ps);
		ArrayList<NsrSbfVO> listLodadata = null;
		if (result != null) {
			listLodadata = new ArrayList<NsrSbfVO>();
			while (result.next())
	...
	public static boolean insert(Connection con, NsrSbfVO vo)
			throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static NsrSbfVO queryByPK(Connection con, String UUID)
			throws SQLException {
		String strSqlWhere = "UUID=? ";
		ArrayList<String> sqlParams = new ArrayList<String>();
		sqlParams.add(UUID);
	 ...
	 * @throws SQLException
	 */
	public static boolean updateByPK(Connection con, String UUID, NsrSbfVO vo)
			throws SQLException {
		String strSqlWhere = "UUID=? ";
		ArrayList<String> sqlParams = new ArrayList<String>();
		sqlParams.add(UUID);
	...
	// //////////////////////////////////////以下为【自定义部分】/////////////////////////////////////////////////////////
	public static List<NsrSbfVO> queryList(Connection conn, String sqlWhere,
			ArrayList<String> sqlParams) throws SQLException {
		List<NsrSbfVO> list = queryByZdyWhere(conn, TABLENAME, null, sqlWhere,
				sqlParams, false);
		return list;
	}
}
