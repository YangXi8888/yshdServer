...
public class NsrXzcfBPO extends CssBaseBPOWithLOB {
	...
	private static NsrXzcfVO loadConcreteBPO(ResultSet rs) throws SQLException,
			TaxBaseBizException {
	...
	private static NsrXzcfVO queryByWhere(Connection con, String tablename,
	...
	private static ArrayList<NsrXzcfVO> queryByZdyWhere(Connection con,
		...
		result = findAllByWhere(con, tablename, sqlOrder, sqlWhere, sqlParams,
				isCount, result, ps);
		ArrayList<NsrXzcfVO> listLodadata = null;
		if (result != null) {
			listLodadata = new ArrayList<NsrXzcfVO>();
			while (result.next())
	...
	public static boolean insert(Connection con, NsrXzcfVO vo)
	 ...
	 * @throws SQLException
	 */
	public static NsrXzcfVO queryByPK(Connection con, String UUID)
			throws SQLException, TaxBaseBizException {
		String strSqlWhere = "UUID=? ";
		ArrayList<String> sqlParams = new ArrayList<String>();
		sqlParams.add(UUID);
	 ...
	 * @throws SQLException
	 */
	public static boolean updateByPK(Connection con, String UUID, NsrXzcfVO vo)
			throws SQLException, TaxBaseBizException {
		String strSqlWhere = "UUID=? ";
		ArrayList<String> sqlParams = new ArrayList<String>();
		sqlParams.add(UUID);
