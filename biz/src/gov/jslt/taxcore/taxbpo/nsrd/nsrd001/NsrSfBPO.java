...
private static  NsrSfVO loadConcreteBPO(ResultSet rs) throws SQLException {
     	...
     	vo.setRkse(String.valueOf(rs.getDouble("RKSE")));
...
private static NsrSfVO queryByWhere(Connection con,String tablename,String sqlOrder,String sqlWhere,ArrayList sqlParams,boolean isCount) throws SQLException {
