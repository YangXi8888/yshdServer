...
private static NsrJbxxVO queryByWhere(Connection con,String tablename,String sqlOrder,String sqlWhere,ArrayList sqlParams,boolean isCount) throws SQLException {
...
public static boolean insert(Connection con , NsrJbxxVO vo)throws SQLException {
...
* @throws SQLException
*/
public static NsrJbxxVO queryByPK(Connection con,String UUID) throws SQLException {
	String strSqlWhere="UUID=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(UUID);
...
* @throws SQLException
*/
 public static boolean updateByPK(Connection con,String UUID, NsrJbxxVO vo) throws SQLException {
	String strSqlWhere="UUID=? ";
	ArrayList sqlParams=new ArrayList();
 	sqlParams.add(UUID);
