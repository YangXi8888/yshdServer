package gov.jslt.taxcore.taxblh.ggfw.zczn.zczn003;
...
public class Zczn003BLH extends BaseBizLogicHandler {
	...
	protected ResponseEvent queryTitle(RequestEvent req, Connection con)
		...
		String colnum = ZBCoreHelper.getColnum_ssyh(colname);
	...
	public static void main(String[] args) {
		String src = "href=\"/art/image.jpg\"";
		System.out.println(src);
		System.out.println(src.replace("href=\"/",
				"href=\"http://pub.jsds.gov.cn/"));
	}
