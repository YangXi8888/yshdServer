...
public class JsltJMSSender {
    ...
    public Map<String, String> synSend(Map<String, Object> reqMap) {
        ...
        try {
            ...
            LogWritter.sysError("组装大集中请求报文成功：" + reqXml);
            System.out.println("组装大集中请求报文成功：" + reqXml);
        } catch (Gt3XmlException e1) {
            LogWritter.sysError("组装大集中请求报文异常：" + e1.getMessage());
            System.out.println("组装大集中请求报文异常：" + e1.getMessage());
